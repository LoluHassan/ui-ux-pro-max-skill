...
```bash
node src/ui-ux-pro-max/scripts/search.js "<query>" --domain <domain> [-n <max_results>]
```
...
**Stack search:**
```bash
node src/ui-ux-pro-max/scripts/search.js "<query>" --stack <stack>
```
...
│   ├── core.js                   # BM25 + regex hybrid search engine
│   └── design_system.js          # Design system generation
└── templates/
...
Node.js (LTS recommended, no external dependencies required)
