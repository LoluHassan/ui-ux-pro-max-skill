...
<p align="center">
  <a href="https://github.com/LoluHassan/ui-ux-pro-max-skill/releases"><img src="https://img.shields.io/github/v/release/LoluHassan/ui-ux-pro-max-skill?style=for-the-badge&color=blue" alt="GitHub Release"></a>
  ...
  <img src="https://img.shields.io/badge/node.js-LTS-green?style=for-the-badge&logo=nodedotjs&logoColor=white" alt="Node.js LTS">
  <a href="https://github.com/LoluHassan/ui-ux-pro-max-skill/blob/main/LICENSE"><img src="https://img.shields.io/github/license/LoluHassan/ui-ux-pro-max-skill?style=for-the-badge&color=green" alt="License"></a>
</p>
...
<p align="center">
  ...
  <a href="https://paypal.me/loluhassan"><img src="https://img.shields.io/badge/PayPal-Donate-00457C?style=for-the-badge&logo=paypal&logoColor=white" alt="PayPal Donate"></a>
</p>
...
The flagship feature of v1.0 is the **Design System Generator** - an AI-powered reasoning engine that analyzes your project requirements and generates a complete, tailored design system in seconds.
...
Node.js is required for the search script.
...
node .claude/skills/ui-ux-pro-max/scripts/search.js "beauty spa wellness" --design-system -p "Serenity Spa"

# Generate with Markdown output
node .claude/skills/ui-ux-pro-max/scripts/search.js "fintech banking" --design-system -f markdown

# Domain-specific search
node .claude/skills/ui-ux-pro-max/scripts/search.js "glassmorphism" --domain style
node .claude/skills/ui-ux-pro-max/scripts/search.js "elegant serif" --domain typography
node .claude/skills/ui-ux-pro-max/scripts/search.js "dashboard" --domain chart

# Stack-specific guidelines
node .claude/skills/ui-ux-pro-max/scripts/search.js "form validation" --stack react
node .claude/skills/ui-ux-pro-max/scripts/search.js "responsive layout" --stack html-tailwind
```
...
node .claude/skills/ui-ux-pro-max/scripts/search.js "SaaS dashboard" --design-system --persist -p "MyApp"

# Also create a page-specific override file
node .claude/skills/ui-ux-pro-max/scripts/search.js "SaaS dashboard" --design-system --persist -p "MyApp" --page "dashboard"
```
...
git clone https://github.com/LoluHassan/ui-ux-pro-max-skill.git
...
# - scripts/*.js            → Search engine & design system
